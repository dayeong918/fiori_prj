		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zsalesorderfi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsalesorderfi-display": {
								"semanticObject": "zsalesorderfi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsalesorderfi",
									"url": sap.ui.require.toUrl("zsalesorderfi")
								}
							}
						}
					}
